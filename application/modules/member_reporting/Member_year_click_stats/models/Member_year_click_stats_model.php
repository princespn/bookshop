 ...
 * @filesource
 */
class Member_year_click_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	public function init_chart($data = array(), $m = '')
	{
		...
		$html['title'] = lang('clicks_generated_per_month');
...
/* End of file Member_year_click_stats_model.php */
/* Location: ./application/modules/member_reporting/Month_click_stats/models/Member_year_click_stats_model.php */