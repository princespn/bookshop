        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card content">
                    <div class="card-body">
                        <h2>{{ lang(config_option('module_payment_gateways_mobilemony_payment_title')) }}</h2>
                        <p>{{ lang(config_option('module_payment_gateways_mobilemony_payment_instructions')) }}</p>
