 ...
 * @filesource
 */
class Facebook_share_model extends Affiliate_marketing_model
{
	protected $id = 'id';
	...
	public function install($id = '')
	{
		...
		$config = array(
			'settings_key'        => 'module_affiliate_marketing_facebook_share_show_product_link',
			'settings_value'      => '1',
...
/* End of file Facebook_share_model.php */
/* Location: ./modules/affiliate_marketing/banners/models/Facebook_share_model.php */