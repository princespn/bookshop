        ...
        <div class="box-info">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="regions">
                    <div>
                        <h3 class="text-capitalize">
                            <span class="visible-lg"><?= lang('free_shipping_zones') ?></span>
                        ...
                        <span class="visible-lg"><?= lang('enable_this_shipping_option_to_specific_zones') ?></span>
                    </div>
                    <hr/>
                    <div id="regions-div">
                        <div class="row text-capitalize hidden-xs">
                            <div class="col-lg-5"><?= tb_header('free_shipping_to_zone', '', FALSE) ?></div>
                            <div class="col-lg-4"><?= tb_header('shipping_description', '', FALSE) ?></div>
                            <div class="col-lg-2"><?= tb_header('if_quantity_type_exceeds', '', FALSE) ?></div>
							...
							<?php else: ?>
                                ...
                                <div class="rowdiv-0">
                                    <div class="row text-capitalize">
                                        ...
                                        <div class="col-lg-2 r">
                                            <input type="text" name="zone[0][amount]" value="0.00" class="form-control">
                                        </div>
