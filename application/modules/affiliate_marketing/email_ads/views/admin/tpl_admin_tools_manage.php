...
<div class="row">
	<div class="col-md-4">
		<?= generate_sub_headline('manage_email_ad', 'fa-edit', '') ?>
	</div>
	<div class="col-md-8 text-right">
		...
		<a href="<?= admin_url(CONTROLLER_CLASS . '/view_rows/0/?module_id=' . $module_id) ?>"
		   class="btn btn-primary"><?= i('fa fa-search') ?> <span
				class="hidden-xs"><?= lang('view_email_ads') ?></span></a>
		<?php if (CONTROLLER_FUNCTION == 'update'): ?>
...
<div class="box-info">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="config">
			<h3 class="text-capitalize"><?= lang('email_ad_details') ?></h3>
			<hr/>
			...
			<hr/>
			<div class="form-group">
				<?= lang('email_ad_title', 'email_ad_title', array('class' => 'col-md-2 control-label')) ?>
				<div class="col-md-5">
					<?= form_input('email_ad_title', set_value('email_ad_title', $row['email_ad_title']), 'id="1" class="' . css_error('email_ad_title') . ' form-control required"') ?>
			...
			<hr/>
			<div class="form-group">
				<?= lang('email_ad_body', 'email_ad_body', array('class' => 'col-md-2 control-label')) ?>
				<div class="col-md-8">
					<?= form_textarea('email_ad_body', set_value('email_ad_body', $row['email_ad_body'], FALSE), 'class="editor ' . css_error('email_ad_body') . ' form-control required"') ?>
