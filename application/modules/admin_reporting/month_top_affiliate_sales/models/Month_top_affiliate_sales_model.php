 ...
 * @filesource
 */
class Month_top_affiliate_sales_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	{
		$sql = 'SELECT p.member_id, SUM(p.sale_amount) as amount,
...
/* End of file month_top_affiliate_sales_model.php */
/* Location: ./application/modules/admin_reporting/month_top_affiliate_sales/models/month_top_affiliate_sales_model.php */