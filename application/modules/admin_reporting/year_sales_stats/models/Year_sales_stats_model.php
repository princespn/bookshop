 ...
 * @filesource
 */
class Year_sales_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	{
		$sql = 'SELECT MONTH( date_purchased ) AS day,
                  SUM( total ) AS amount
                  FROM ' . $this->db->dbprefix(TBL_INVOICES) . '
                  WHERE date_purchased BETWEEN \'' . current_date('Y') . '-01-01 00:00:00\'
...
/* End of file Year_sales_stats_model.php */
/* Location: ./application/modules/admin_reporting/year_sales_stats/models/year_sales_stats_model.php */