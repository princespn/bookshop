...
<div class="row">
    ...
    <div class="col-md-8 text-right">
        <a href="<?= admin_url(TBL_MODULES . '/external/' . $row['module']['module_type'] . '/' . $row['module']['module_folder']) ?>"
           class="btn btn-danger" target="_blank"><?= i('fa fa-external-link') ?> <?= lang('signup_for_easypost') ?></a>
                ...
                <div class="tab-pane" id="regions">
                    ...
                    <div id="regions-div">
                        <div class="row text-capitalize hidden-xs">
                            <div class="col-lg-6"><?= tb_header('ship_to_zones', '', FALSE) ?></div>
                            <div class="col-lg-5"><?= tb_header('shipping_description', '', FALSE) ?></div>
