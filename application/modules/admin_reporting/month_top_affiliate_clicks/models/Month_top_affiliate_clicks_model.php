 ...
 * @filesource
 */
class Month_top_affiliate_clicks_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	{
		$sql = 'SELECT p.member_id, COUNT(p.traffic_id) as amount,
...
/* End of file month_top_affiliate_clicks_model.php */
/* Location: ./application/modules/admin_reporting/month_top_affiliate_clicks/models/month_top_affiliate_clicks_model.php */