		...
		<div class="box-info">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="config">
					...
					<hr/>
					<div class="form-group">
						<?= lang('enabled', 'status', array('class' => 'col-md-3 control-label')) ?>
						<div class="col-md-5">
							<?= form_dropdown('status', options('yes_no'), $row['module']['module_status'], 'class="form-control"') ?>
						</div>
					</div>
					<hr/>
				...
				<div class="tab-pane" id="regions">
					<div>
						...
						<span class="visible-lg"><?= lang('setup_percentage_shipping_amounts') ?></span>
					</div>
					<hr/>
					<div id="regions-div">
						<div class="row text-capitalize hidden-xs">
							<div class="col-lg-5"><?= tb_header('ship_to_zones', '', FALSE) ?></div>
							<div class="col-lg-4"><?= tb_header('shipping_description', '', FALSE) ?></div>
							<div class="col-lg-2"><?= tb_header('percentage_amount', '', FALSE) ?></div>
						...
						<?php else: ?>
							...
							<div class="rowdiv-0">
								<div class="row text-capitalize">
									...
									<div class="col-lg-4 r">
										<input type="text" name="zone[0][shipping_description]" class="form-control">
									</div>
									<div class="col-lg-2 r">
