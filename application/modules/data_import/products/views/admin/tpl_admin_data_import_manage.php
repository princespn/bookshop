...
<?= form_close() ?>
<script>
	<?php if ($module_data_import_products_use_server_path == '1'): ?>
	$("#module_data_import_products_server_file_path_box").show(100);
	$("#upload-box").hide(100);
	<?php else: ?>
	$("#module_data_import_products_server_file_path_box").hide(100);
	$("#upload-box").show(100);
	<?php endif; ?>

	$("#module_data_import_products_use_server_path").change(function () {
				...
				$.ajax({
					...
					success: function (data) {
						if (data['type'] == 'error') {
							...
							$('#module_data_import_products_server_file_path').attr('value', data['file_name']);
