...
ALTER TABLE `jrox_promotional_rules`
  ADD CONSTRAINT `jrox_promotional_rules_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `jrox_products` (`product_id`) ON DELETE CASCADE;
