 ...
 * @filesource
 */
class Discount_groups extends Admin_Controller
{

	protected $data = '';

	protected $table = TBL_DISCOUNT_GROUPS;
	...
	public function view()
	{
		...
		//run the page
		$this->load->page('promotions/' . TPL_ADMIN_DISCOUNT_GROUPS_VIEW, $this->data);
	}
	...
	public function create()
	{
		...
		if ($this->input->post())
		{
			...
			$row = $this->group->validate($this->input->post());
		...
		$this->load->page('promotions/' . TPL_ADMIN_DISCOUNT_GROUP_CREATE, $this->data);
	}
	...
	public function update()
	{
		...
		$this->load->page('promotions/' . TPL_ADMIN_DISCOUNT_GROUP_UPDATE, $this->data);
	}
	...
	{
		$term = $this->input->get('disc_group_name', TRUE);
