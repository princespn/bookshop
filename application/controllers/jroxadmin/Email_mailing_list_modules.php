 ...
 * @filesource
 */
class Email_mailing_list_modules extends Admin_Controller
{
	/**
	 * @var array
	 */
	...
	{
		redirect_page(ADMIN_ROUTE . '/' . TBL_EMAIL_MAILING_LISTS . '/view');
	}
	...
	public function update()
	{
		...
		if ($this->input->post())
		{
			...
			$row = $this->$module->validate_module($this->input->post());
...
/* End of file Email_mailing_list_modules.php */
/* Location: ./application/controllers/admin/Email_mailing_list_modules.php */