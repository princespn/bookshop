 ...
 * @filesource
 */
class Member_month_commission_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	public function init_chart($data = array(), $days = '')
	{
		...
		$html['title'] = lang('commissions_generated_per_day');
...
/* End of file Member_month_commission_stats_model.php */
/* Location: ./application/modules/member_reporting/Month_commission_stats/models/Member_month_commission_stats_model.php */