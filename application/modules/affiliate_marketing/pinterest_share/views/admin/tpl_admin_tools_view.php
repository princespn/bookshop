...
<div class="row">
	<div class="col-md-8">
		<div class="input-group text-capitalize">
			<?= generate_sub_headline('pinterest_affiliate_links', 'fa-list', $rows['total']) ?>
		</div>
	</div>
	<div class="col-md-4 text-right">
		...
		<a href="<?= admin_url(CONTROLLER_CLASS . '/create/' . $module_row['module']['module_id']) ?>"
		   class="btn btn-primary <?= is_disabled('create') ?>"><?= i('fa fa-plus') ?> <span
				class="hidden-xs"><?= lang('add_link') ?></span></a>
...
<div class="box-info">
	<div class="row">
		...
		<div class="col-md-9"><?= tb_header('link_name', 'name') ?></div>
	...
	<div id="sortable">
		...
		<div class="ui-state-default" id="formid-<?= $v['id'] ?>">
			<div class="row">
				...
				<div class="col-md-9"><h5><?= $v['name'] ?></h5></div>
