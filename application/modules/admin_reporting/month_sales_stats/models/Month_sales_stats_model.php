 ...
 * @filesource
 */
class Month_sales_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	{
		$html = $this->init_data($data, $days, 'stats');
	...
	protected function run_query($days = '', $m = '', $y = '')
	{
		$sql = 'SELECT DAY( date_purchased ) AS day,
                  ...
                  WHERE date_purchased BETWEEN \'' . current_date('Y', $m, '', $y) . '-' . current_date('m', $m) . '-01 00:00:00\'
...
/* End of file month_sales_stats_model.php */
/* Location: ./application/modules/admin_reporting/month_sales_stats/models/month_sales_stats_model.php */