 ...
 * @filesource
 */
class Week_affiliate_clicks_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	public function generate_module($data = array())
	{
		//generate the data
		$days = 7;
		$range = array('start' => get_time(strtotime('-7 day', now()), TRUE),
		               'end'   => get_time(now(), TRUE));
...
/* End of file week_affiliate_clicks_stats_model.php */
/* Location: ./application/modules/admin_reporting/week_affiliate_clicks_stats/models/week_affiliate_clicks_stats_model.php */