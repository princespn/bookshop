 ...
 * @filesource
 */
class Month_invoice_payments_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	protected function run_query($days = '', $m = '', $y = '')
	{
		$sql = 'SELECT DAY( date ) AS day,
                  ...
                  SUM(fee) AS fee
                  FROM ' . $this->db->dbprefix(TBL_INVOICE_PAYMENTS) . '
...
/* End of file month_invoice_payments_stats_model.php */
/* Location: ./application/modules/admin_reporting/month_invoice_payments_stats/models/month_invoice_payments_stats_model.php */