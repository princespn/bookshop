 ...
 * @filesource
 */
class Pinterest_share_model extends Affiliate_marketing_model
{
	protected $id = 'id';
	...
	public function install($id = '')
	{
		...
		$sql = "CREATE TABLE IF NOT EXISTS " . $this->db->dbprefix(config_item('module_table')) . " (
                  ...
                  `image_file_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
		...
		$config = array(
			'settings_key'        => 'module_affiliate_marketing_pinterest_share_show_product_link',
			'settings_value'      => '1',
	...
	function parse_tags($data = array())
	{
		foreach ($data as $k => $v)
		{
			$data[$k]['link_text'] = parse_string($v['link_text'], session_tags('/tools/pinterest_share/' . $v['id']));
		}
...
/* End of file Pinterest_share_model.php */
/* Location: ./modules/affiliate_marketing/banners/models/Pinterest_share_model.php */