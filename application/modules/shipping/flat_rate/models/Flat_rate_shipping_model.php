 ...
 * @filesource
 */
class Flat_rate_shipping_model extends Shipping_model
{
	...
	public function install($id = '')
	{
		...
		$config = array(
			'settings_key'        => 'module_shipping_flat_rate_charge_shipping_tax',
			'settings_value'      => '0',
		...
		$config = array(
			'settings_key'        => 'module_shipping_flat_rate_tax_class',
			'settings_value'      => '1',
			'settings_module'     => 'shipping',
			'settings_type'       => 'dropdown',
			'settings_group'      => $id,
	...
	public function generate_rates($data = array(), $cart = array())
	{
		...
		if (!empty($zone_rate))
		{
			...
			$zone_rate['shipping_taxes'] = calc_shipping_taxes($zone_rate['shipping_amount'], 'flat_rate');
...
/* Location: ./application/modules/shipping/flat_rate/models/Flat_rate_model.php */