...
<?php else: ?>
	<div class="box-info">
		...
		<div class="row text-capitalize hidden-xs hidden-sm">
			...
			<div class="col-md-1"><h5><?= lang('starts_on') ?></h5></div>
			<div class="col-md-1"><h5><?= lang('expires_on') ?></h5></div>
		...
		<?php foreach ($rows[ 'values' ] as $v): ?>
			<div class="row">
				...
				<div class="col-md-1 text-center hidden-xs hidden-sm">
					<a
						href="<?= admin_url('update_status/table/' . CONTROLLER_CLASS . '/type/status/key/rule_id/id/' . $v[ 'rule_id' ]) ?>"
				...
				<div class="col-md-1 hidden-xs hidden-sm">
					<h5><?= display_date($v[ 'start_date' ]) ?></h5>
				</div>
				<div class="col-md-1 hidden-xs hidden-sm">
