 ...
 * @filesource
 */
class Member_year_sales_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	public function init_chart($data = array(), $m = '')
	{
		...
		$html['title'] = lang('sales_generated_per_month');
...
/* End of file Member_year_sales_stats_model.php */
/* Location: ./application/modules/member_reporting/Month_sales_stats/models/Member_year_sales_stats_model.php */