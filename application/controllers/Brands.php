 ...
 * @filesource
 */
class Brands extends Product_Controller
{
    protected $data;
	...
	public function view()
    {
        ...
        //get the brands
        $this->data['brands'] = $this->brands->load_brands(query_options($opt), sess('default_lang_id'), FALSE);

        $tpl = $this->input->get('q') == 'ajax' ? '_ajax' : '';
        $this->show->display('product', 'brands' . $tpl, $this->data);
    }
}
