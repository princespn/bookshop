 ...
 * @filesource
 */
class Year_support_tickets_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	{
		$sql = 'SELECT MONTH( date_added ) AS day,
                  COUNT(ticket_id) AS amount
                  FROM ' . $this->db->dbprefix(TBL_SUPPORT_TICKETS) . '
                  WHERE date_added BETWEEN \'' . current_date('Y') . '-01-01 00:00:00\'
...
/* End of file Year_support_tickets_stats_model.php */
/* Location: ./application/modules/admin_reporting/year_support_tickets_stats/models/year_support_tickets_stats_model.php */