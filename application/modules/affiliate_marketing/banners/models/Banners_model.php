 ...
 * @filesource
 */
class Banners_model extends Affiliate_marketing_model
{
	protected $id = 'id';
	...
	public function install($id = '')
	{
		...
		$sql = "CREATE TABLE IF NOT EXISTS " . $this->db->dbprefix(config_item('module_table')) . " (
                  ...
                  `rotator_group` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
...
/* Location: ./modules/affiliate_marketing/banners/models/Banners_model.php */