 ...
 * @filesource
 */
class Week_sales_stats_model extends Reports_model
{
	/**
	 * Install module
	 *
	...
	protected function run_query($range)
	{
		$sql = 'SELECT DAY( date_purchased ) AS day,
                  ...
                  WHERE date_purchased BETWEEN \'' . $range['start'] . '\'
                    AND \'' . $range['end'] . '\'';
...
/* End of file week_sales_stats_model.php */
/* Location: ./application/modules/admin_reporting/week_sales_stats/models/week_sales_stats_model.php */