...
<div class="row">
    <div class="col-md-4">
	    <?= generate_sub_headline($module_row['module']['module_name'] . ' - ' . lang('settings'), 'fa-pencil', '', FALSE) ?>
    </div>
    <div class="col-md-8 text-right">
        <a href="<?= admin_url(CONTROLLER_CLASS . '/view') ?>" class="btn btn-primary">
            <?= i('fa fa-search') ?> <span class="hidden-xs"><?= lang('view_affiliate_tools') ?></span></a>
    </div>
</div>
<hr/>
<div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" name="module_sort_order"
                                   value="<?= set_value('module_sort_order', $module_row['module']['module_sort_order']) ?>"
