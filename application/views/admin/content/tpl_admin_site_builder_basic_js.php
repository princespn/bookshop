...
<?php if (!empty($widgets)): ?>
	<?php foreach ($widgets as $v): ?>
		<?php if (in_array($v['widget_category'], config_item('section_sitebuilder_basic_js'))): ?>
            {
            'thumbnail': 'preview/<?=$v['thumbnail']?>',
            'category': '<?=$v['widget_category']?>',
            'googleFonts': [],
            'contentCss': '<?=$v['content_class']?>.css',
            'contentClass': '<?=$v['content_class']?>',
            'name': '<?=$v['widget_name']?>',
            'html':
            '<?=$v['preview_code']?>'
            },
...
'contentClass': '',
'html':
'<div class="is-section is-box is-dark-text is-section-50 is-static">' +
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container is-content-1200">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full center">' +
                        _tabs(6) + '<h1 class="size-32 is-title1-32 is-title-lite"><?=$sts_site_shipping_name?></h1>' +
                        _tabs(6) + '<p>' +
                            _tabs(7) + '<?=$sts_site_shipping_address_1 ?> <?=$sts_site_shipping_city?>, <?=$sts_site_shipping_region_name?> <?=$sts_site_shipping_postal_code?> <?=$sts_site_shipping_country_iso_code_3?><br>' +
                            _tabs(7) + 'P: <?=$sts_site_phone_number?>' +
                            _tabs(6) + '</p>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full center">' +
                        _tabs(6) + '<div class="is-social size-21" style="margin: 20px 0">' +
                            _tabs(7) + '<a href="<?=$sts_site_twitter_url?>"><i class="icon ion-social-twitter" style="margin-right: 2em"></i></a>' +
                            _tabs(7) + '<a href="<?=$sts_site_facebook_url?>"><i class="icon ion-social-facebook" style="margin-right: 2em"></i></a>' +
                            _tabs(7) + '<a href="https://plus.google.com/"><i class="icon ion-social-googleplus" style="margin-right: 2em"></i></a>' +
                            _tabs(7) + '<a href="mailto:<?=encode_email($sts_site_email)?>"><i class="icon ion-android-drafts"></i></a>' +
                            _tabs(6) + '</div>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full center">' +
                        _tabs(6) + '<p class="size-14">Copyright <?=date('Y')?> <?=$sts_site_shipping_name?></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(3) + '</div>' +
            _tabs(2) + '</div>' +
...
'<div class="is-section is-box is-dark-text is-section-50 is-static">' +
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container is-content-1100">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full">' +
                        _tabs(6) + '<h1 class="size-24 is-title1-24 is-title-lite" style="line-height: 50px;"><?=$sts_site_name?></h1>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column third">' +
                        _tabs(6) + '<p><a href="/">HOME</a></p>' +
                        _tabs(6) + '<p><a href="#">SERVICES</a></p>' +
                        _tabs(6) + '<p><a href="#">ABOUT</a></p>' +
                        _tabs(6) + '<p><a href="/contact">CONTACT</a></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third">' +
                        _tabs(6) + '<p>' +
                            _tabs(7) + 'ADDRESS:<br>' +
                            _tabs(7) + '<?=$sts_site_shipping_address_1 ?> <?=$sts_site_shipping_city?>, <br>' +
                            _tabs(7) + '<?=$sts_site_shipping_region_name?> <?=$sts_site_shipping_postal_code?> <?=$sts_site_shipping_country_iso_code_3?><br>' +
                            _tabs(7) + 'P: <?=$sts_site_phone_number?>' +
                            _tabs(6) + '</p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third">' +
                        _tabs(6) + '<p>GET IN TOUCH:</p>' +
                        _tabs(6) + '<div class="is-social">' +
                            _tabs(7) + '<a href="<?=$sts_site_twitter_url?>"><i class="icon ion-social-twitter"></i></a>' +
                            _tabs(7) + '<a href="<?=$sts_site_facebook_url?>"><i class="icon ion-social-facebook"></i></a>' +
                            _tabs(7) + '<a href="https://plus.google.com/"><i class="icon ion-social-googleplus"></i></a>' +
                            _tabs(7) + '<a href="mailto:<?=encode_email($sts_site_email)?>"><i class="icon ion-android-drafts"></i></a>' +
                            _tabs(6) + '</div>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full">' +
                        _tabs(6) + '<p class="size-14" style="text-align: center;">Copyright <?=date('Y')?> <?=$sts_site_shipping_name?></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(3) + '</div>' +
            _tabs(2) + '</div>' +
...
'contentClass': '',
'html':
'<div class="is-section is-box is-section-20 is-dark-text is-static">' +
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container is-content-1200">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column third center">' +
                        _tabs(6) + '<p class="size-24" style="letter-spacing: 4px;"><?=$sts_site_name?></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third center">' +
                        _tabs(6) + '<p class="size-16" style="line-height: 49px;">Copyright <?=date('Y')?> <?=$sts_site_shipping_name?></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third center">' +
                        _tabs(6) + '<div class="is-social" style="margin: 25px 0">' +
                            _tabs(7) + '<a href="<?=$sts_site_twitter_url?>"><i class="icon ion-social-twitter"></i></a>' +
                            _tabs(7) + '<a href="<?=$sts_site_facebook_url?>"><i class="icon ion-social-facebook"></i></a>' +
                            _tabs(7) + '<a href="https://plus.google.com/"><i class="icon ion-social-googleplus"></i></a>' +
                            _tabs(7) + '<a href="mailto:<?=encode_email($sts_site_email)?>"><i class="icon ion-android-drafts"></i></a>' +
...
'contentClass': '',
'html':
'<div class="is-section is-box is-section-50 is-dark-text is-static">' +
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container is-content-1200">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column third">' +
                        _tabs(6) + '<h3 class="size-18 is-title-lite"><?=strtoupper($sts_site_name)?></h3>' +
                        _tabs(6) + '<p style="border-bottom: 2px solid #e67e22; width: 40px; display: inline-block; margin-top: 0"></p>' +
                        _tabs(6) + '<p class="size-16">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third">' +
                        _tabs(6) + '<h3 class="size-18 is-title-lite">ADDRESS</h3>' +
                        _tabs(6) + '<p style="border-bottom: 2px solid #e67e22; width: 40px; display: inline-block; margin-top: 0"></p>' +
                        _tabs(6) + '<p class="size-16">' +
                            _tabs(7) + '<?=$sts_site_shipping_address_1 ?> <?=$sts_site_shipping_city?>, <?=$sts_site_shipping_region_name?> <?=$sts_site_shipping_postal_code?> <?=$sts_site_shipping_country_iso_code_3?><br>' +
                            _tabs(7) + 'P: <?=$sts_site_phone_number?>' +
                        ...
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third">' +
                        _tabs(6) + '<h3 class="size-18 is-title-lite">FOLLOW US</h3>' +
                        _tabs(6) + '<p style="border-bottom: 2px solid #e67e22; width: 40px; display: inline-block; margin-top: 0"></p>' +
                        _tabs(6) + '<div class="is-social" style="margin: 25px 0">' +
                            _tabs(7) + '<a href="<?=$sts_site_twitter_url?>"><i class="icon ion-social-twitter"></i></a>' +
                            _tabs(7) + '<a href="<?=$sts_site_facebook_url?>"><i class="icon ion-social-facebook"></i></a>' +
                ...
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full">' +
                        _tabs(6) + '<div class="spacer height-40"></div>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full">' +
    ...
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container is-content-800">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full center">' +
                        _tabs(6) + '<h1 class="size-48 is-title1-48 is-title-lite"><b><span style="color: #c5c5c5;">COMPANY</span> <span style="color: #f39c12;">NAME</span></b></h1>' +
                        _tabs(6) + '<p>' +
                            _tabs(7) + '<?=$sts_site_shipping_address_1 ?> <?=$sts_site_shipping_city?>, <?=$sts_site_shipping_region_name?> <?=$sts_site_shipping_postal_code?> <?=$sts_site_shipping_country_iso_code_3?><br>' +
                            _tabs(7) + 'P: <?=$sts_site_phone_number?>' +
                            _tabs(6) + '</p>' +
...
{
'thumbnail': 'preview/footer-06.png',
'category': '117',
'contentCss': '',
'contentClass': '',
'html':
    ...
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container is-content-1200">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column third center">' +
                        _tabs(6) + '<i class="icon ion-ios-book-outline size-32" style="color: rgb(136, 136, 136);"></i>' +
                        _tabs(6) + '<p><?=$sts_site_shipping_name?> <?=$sts_site_shipping_address_1 ?> <?=$sts_site_shipping_city?>, <?=$sts_site_shipping_region_code?></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third center">' +
                        _tabs(6) + '<i class="icon ion-ios-telephone-outline size-32" style="color: rgb(136, 136, 136);"></i>' +
                        _tabs(6) + '<p><?=$sts_site_phone_number?></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(5) + '<div class="column third center">' +
                        _tabs(6) + '<i class="icon ion-ios-email-outline size-32" style="color: rgb(136, 136, 136);"></i>' +
                        _tabs(6) + '<p><a href="mailto:<?=encode_email($sts_site_email)?>" style="color: #333" title=""><?=$sts_site_email?></a></p>' +
                        _tabs(5) + '</div>' +
                    _tabs(4) + '</div>' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full">' +
...
'<div class="is-section is-section-100 is-light-text is-box">' +
    _tabs(1) + '<div class="is-overlay">' +
        _tabs(2) + '<div class="is-overlay-bg" style="background-image: url(<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample1.jpg);" data-bottom-top="transform:translateY(-120px) scale(1.05);" data-top-bottom="transform:translateY(120px) scale(1.05)"></div>' +
...
'<div class="is-section is-section-100 is-box">' +
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-centered">' +
            _tabs(3) + '<div class="is-container is-builder container">' +
                _tabs(4) + '<div class="row clearfix">' +
                    _tabs(5) + '<div class="column full">' +
    ...
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-4 is-box-img is-box">' +
            _tabs(3) + '<div class="is-overlay">' +
                _tabs(4) + '<div class="is-overlay-bg" style="background-image: url(<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample1.jpg);" data-bottom-top="transform:translateY(-120px) scale(1.05);" data-top-bottom="transform:translateY(120px) scale(1.05)"></div>' +
...
'<div class="is-section is-section-100 is-shadow-1">' +
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-6 is-box is-align-left is-bg-grey is-light-text">' +
            _tabs(3) + '<div class="is-overlay">' +
                _tabs(4) + '<div class="is-overlay-content content-selectable" data-module="slider" data-module-desc="Slider" data-html="%3Cdiv%20id%3D%22{id}%22%20class%3D%22slider-on-box%22%20style%3D%22width%3A100%25%3Bheight%3A100%25%3B%22%3E%3Cdiv%20class%3D%22is-boxes%20slider-image%22%20style%3D%22background-image%3Aurl(<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample2.jpg)%3B%22%3E%3C%2Fdiv%3E%3Cdiv%20class%3D%22is-boxes%20slider-image%22%20style%3D%22background-image%3Aurl(<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample1.jpg)%3B%22%3E%3C%2Fdiv%3E%3C%2Fdiv%3E%3Cscript%3E%0Avar%20docReady%3Dfunction(fn)%7Bvar%20stateCheck%3DsetInterval(function%20()%7Bif(document.readyState!%3D%3D%22complete%22)return%3BclearInterval(stateCheck)%3Btry%7Bfn()%7Dcatch(e)%7B%7D%7D%2C1)%3B%7D%3B%0AdocReady(function()%20%7B%0AjQuery(%22%23{id}%22).slick(%7B%0Adots%3A%20false%2Carrows%3A%20true%2Cinfinite%3A%20true%2Cspeed%3A%20500%2CcssEase%3A%20%22linear%22%2CslidesToShow%3A%201%2Cautoplay%3A%20true%2CautoplaySpeed%3A%203000%2Cfade%3A%20false%2CadaptiveHeight%3A%20true%2Cresponsive%3A%20%5B%7Bbreakpoint%3A%20480%2Csettings%3A%20%7Barrows%3A%20false%2CslidesToShow%3A%201%7D%7D%5D%0A%7D)%3B%0A%7D)%3B%0A%3C%2Fscript%3E" data-settings="%5B%7B%22auto%22%3Atrue%2C%22arrow%22%3Atrue%2C%22dots%22%3Afalse%2C%22fade%22%3Afalse%2C%22height%22%3A%22100%25%22%2C%22images%22%3A%5B%7B%22src%22%3A%20%22<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample2.jpg%22%2C%20%22caption%22%3A%20%22%22%2C%20%22link%22%3A%20%22%22%2C%20%22width%22%3A%20%22450%22%2C%20%22position%22%3A%20%22bottom%20left%22%7D%2C%7B%22src%22%3A%20%22<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample1.jpg%22%2C%20%22caption%22%3A%20%22%22%2C%20%22link%22%3A%20%22%22%2C%20%22width%22%3A%20%22450%22%2C%20%22position%22%3A%20%22bottom%20left%22%7D%5D%7D%5D"></div>' +
                _tabs(3) + '</div>' +
            _tabs(3) + '<div class="is-boxes">' +
                _tabs(4) + '<div class="is-box-centered">' +
                    _tabs(5) + '<div class="is-container is-builder is-content-500 container">' +
...
'<div class="is-section is-section-100 is-box is-bg-grey is-light-text">' +
    _tabs(1) + '<div class="is-overlay">' +
        ...
        _tabs(2) + '<div class="is-overlay-content" data-module="video-bg" data-module-desc="Video Background" data-dialog-width="600px" data-dialog-height="270px" ' +
        'data-html="' +
        encodeURIComponent('' +
        _tabs(3) + '<video class="is-video-bg" playsinline autoplay muted loop>' +
            _tabs(4) + '<source src="<?=base_folder_path(SITE_BUILDER)?>/assets/designs/videos/example1.mp4" type="video/mp4">' +
            _tabs(3) + '</video>' +
        _tabs(3) + '<div class="is-overlay-video"></div>' +
        _tabs(2)) +
        '"' +
        'data-settings="' +
        encodeURIComponent('[{ "mp4": "<?=base_folder_path(SITE_BUILDER)?>/assets/designs/videos/example1.mp4", "poster": "", "overlay": 0.25}]') +
        '">' +
        '</div>' +
    ...
    _tabs(1) + '<div class="is-boxes">' +
        _tabs(2) + '<div class="is-box-6 is-box is-bg-grey is-light-text">' +
            _tabs(3) + '<div class="is-overlay">' +
                ...
                _tabs(4) + '<div class="is-overlay-content" data-module="video-bg" data-module-desc="Video Background" data-dialog-width="600px" data-dialog-height="270px" ' +
                'data-html="' +
                encodeURIComponent('' +
                _tabs(5) + '<video class="is-video-bg" playsinline autoplay muted loop>' +
                    _tabs(6) + '<source src="<?=base_folder_path(SITE_BUILDER)?>/assets/designs/videos/example1.mp4" type="video/mp4">' +
                    _tabs(5) + '</video>' +
...
'<div class="is-section is-section-100 is-stretch is-box">' +
    '<div>' +
        '<div class="is-module"><div data-type="preview" data-id="32"></div></div>' +
        '</div>' +
    '</div>' +
'</div>'
},
    ...
    '<div class="is-boxes">' +
        '<div class="is-box-4 is-box-img is-box">' +
            '<div class="is-overlay">' +
                '<div class="is-overlay-bg" style="background-image: url(<?=base_folder_path(SITE_BUILDER)?>/assets/designs/images/sample1.jpg);"></div>' +
